  ...
  run() {
    const programs = [
      ...
      },
      {
        title: "Star Wars",
        synopsis:
          "La guerre civile fait rage entre l'Empire galactique et l'Alliance rebelle. Capturée par les troupes de choc de l'Empereur menées par le sombre et impitoyable Dark Vador, la princesse Leia Organa dissimule les plans de l'Etoile Noire.",
        poster:
          "https://media.electre-ng.com/images/image-id/2ac1fd6fd11a74bd93e4dc8fb1e91ec74534a2832c05cebcc22eeae854d6f79f.jpg",
        country: "USA",
        release_year: 1977,
        category_id: this.getRef("category_Science-Fiction").insertId,
      },
      {
        ...
        synopsis:
          "La guerre civile fait rage entre l'Empire galactique et l'Alliance rebelle. Capturée par les troupes de choc de l'Empereur menées par le sombre et impitoyable Dark Vador, la princesse Leia Organa dissimule les plans de l'Etoile Noire.",
        poster:
          "https://fr.web.img2.acsta.net/pictures/14/09/23/10/28/237103.jpg",
        country: "Italie",
        release_year: 1968,
        category_id: this.getRef("category_Western").insertId,
      },
    ];
